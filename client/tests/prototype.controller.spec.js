...
describe('PrototypeCtrl', function () {
    ...
    var currentProjectName = 'TestProject';
    var mockedActiveProjectService = {id: currentProjectId, name: 'Test Project', updateHeading: function () {}};
    ...
    it('should call stateprovider function go when open page map view is clicked', function () {
        ...
        expect(stateSpy.calledWith('page-map-view', {currentProject: currentProjectId})).to.be.equal(true);
    });
});
