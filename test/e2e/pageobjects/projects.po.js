...
Projects.prototype = Object.create({}, {
    ...
    showMoreProjects:    { get:   function ()     { return element(by.css('.project-all-link'))}},
    //
    deleteProjLink:     { get:   function ()    { return element(by.css('.ui-project-tile-cancel-icon'))}},
    checkHeroBannerTitle: { get: function ()         {   return element(by.css('.navbar-title'));}},
    ...
    clickShowMoreProj:  {   value: function()           { this.showMoreProjects.click()}},
